...
### Caixa Fácil · Do Problema à Solução

← [Anterior: Empatize e Defina](./problem-statement.md) · [Voltar ao índice](../README.md) · [Próximo: Arquitetura →](../architecture/overview.md)
...
Mede o tempo entre o cadastro e o primeiro momento em que o usuário visualiza um indicador de orçamento no dashboard. Meta: < 10 minutos.

**Retenção — D7 e D30**
Percentual de usuários que retornam ao produto no 7º e 30º dia após o cadastro. Benchmarks: D7 ≥ 40%, D30 ≥ 25%.

**Engajamento — DAU/MAU (Stickiness)**
Razão entre usuários ativos diários e mensais. Benchmark saudável para apps financeiros: entre 20% e 35%.

**Onboarding — Taxa de conclusão do setup inicial**
Percentual de usuários que completam o fluxo inicial após o registro. Meta: > 70%.

**Alertas — Taxa de engajamento com alertas de orçamento**
Percentual de usuários que, ao receber um alerta de 80%, tomam alguma ação nos 30 minutos seguintes.
...
- Plotline — *Mobile App Engagement Metrics* · https://www.plotline.so/blog/mobile-app-engagement-metrics
...
- Integração com Open Finance do Banco Central
